...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--dpop_support",
        choices=["sampo_subset", "full_chosen"],
        default=None,
        help=(
            "DPOP anchor support: sampo_subset (default; anchor uses the same subset as the "
            "preference margin) or full_chosen (decoupled; anchor uses the full chosen completion)."
        ),
    )
    p.add_argument(
        "--trainer",
...
def main() -> None:
    ...
    dpop_support = args.dpop_support or arm.get("dpop_support", "sampo_subset")
    ...
    print(
        ...
        f"length_debias={length_debias} dpop_lambda={dpop_lambda} dpop_support={dpop_support} "
